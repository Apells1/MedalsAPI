      ...
      [HttpGet, SwaggerOperation(summary: "returns all countries", null)]
       ...
       [HttpGet("{id}"), SwaggerOperation(summary: "return a country with a user-defined id", null)
        public Country Get(int id)
        {
          ...
          [HttpPost, SwaggerOperation(summary: "add a country", null), ProducesResponseType(typeof(Country), 201), SwaggerResponse(201, "Done!")]
        // add country
        public Country Post([FromBody] Country country) => _dataContext.AddCountry(country);
              [HttpDelete("{id}"), SwaggerOperation(summary: "delete a country", null), ProducesResponseType(typeof(Country), 204), SwaggerResponse(204, "Done!")]
